...
This library was extracted from the [[https://github.com/inaimathi/cl-mop][cl-mop project (MIT)]] and then it began to accrete more functionality as I ran across a need for more utilities dealing with the CLOS/MOP.
